...
public class Dictionary {
	...
	private void loadMainDict() {
		...
		try {
			...
			log.error("Main Dictionary loading exception.", e);
		} finally {
			try {
				if (is != null) {
					is.close();
		...
		if (extDictFiles != null) {
			...
			for (String extDictName : extDictFiles) {
				...
				try {
					...
					log.error("Extension Dictionary loading exception.", e);
				} finally {
					try {
						if (is != null) {
							is.close();
		...
		if (extStopWordDictFiles != null) {
			...
			for (String extStopWordDictName : extStopWordDictFiles) {
				...
				try {
					...
					log.error("Extension Stop word Dictionary loading exception.", e);
				} finally {
					try {
						if (is != null) {
							is.close();
	...
	private void loadQuantifierDict() {
		...
		try {
			...
			log.error("Quantifier Dictionary loading exception.", e);
		} finally {
			try {
				if (is != null) {
					is.close();
